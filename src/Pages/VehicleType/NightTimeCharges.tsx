...
const NightTimeCharges: React.FC = () => {
  ...
  return (
    <div className="p-4 max-w-[1200px] mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-xl font-bold">Night Time Charges</h1>
        <Button onClick={handleAddNew}>Add New</Button>
      </div>

      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-xl font-semibold mb-4">Night Time Charges</h2>
...
export default NightTimeCharges;
